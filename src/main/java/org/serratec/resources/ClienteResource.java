...
public class ClienteResource {
	...
	public ResponseEntity<?> getDetalhe(@PathVariable Long id) {
		...
		try {
			Cliente cliente = clienteRepository.findById(id).orElseThrow(() -> new ClienteException("Cliente nao encontrado"));
	...
	@ApiOperation(value = "Atualizacao de um cliente a partir do seu ID")
	...
	@ApiOperation(value = "Desativacao da conta do cliente")
	@GetMapping("/cliente/desativar/{email}")
	public ResponseEntity<?> getDesativar(@PathVariable String email) {

		try {
			Cliente cliente = clienteRepository.findByEmail(email).orElseThrow(() -> new ClienteException("Cliente nao encontrado."));
	...
	@ApiOperation(value = "Ativacao da conta do cliente")
