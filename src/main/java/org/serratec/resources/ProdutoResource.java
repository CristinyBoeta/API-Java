...
public class ProdutoResource {
	...
	@ApiOperation(value = "Visualizacao de  imagem de um produto")
	...
	@ApiOperation(value = "Atualizacao de um produto pelo seu ID")
	...
	@ApiOperation(value = "Exclusao de um produto")
